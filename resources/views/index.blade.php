...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('storage/app/public/imgs/Favicon.png') }}">
    ...
    <div class="container" >
        ...
        <div class="navbar-header">
            ...
            <a href="#" class="navbar-brand">
                <img src="{{ asset('storage/app/public/imgs/FiftyShadesofCode.png') }}" alt="Fifty Shades of Code text" />
            </a>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="home-img">
                    <img src="{{ asset('storage/app/public/imgs/Logo.gif') }}" alt="Dragon with Neck Tie" />
                </div>
            </div>
