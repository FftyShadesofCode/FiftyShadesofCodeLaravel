        ...
        <div class="row">
            ...
            <div class="bg-red col-md-3 col-sm-6">
                <div class="wow fadeInUp color-white service-thumb" data-wow-delay="0.8s">
                    ...
                    <p class="color-white">Designing User Interfaces for Machines and Software, such as Computers, Home Appliances, Mobile Devices, and Other Electronic Devices, With the Focus on Maximizing Usability and the User Experience</p>
                </div>
            </div>
